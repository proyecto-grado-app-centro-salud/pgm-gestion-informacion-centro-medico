...
import com.example.microservicio_informacion_centro_medico.security.jwt.CustomAccessDeniedHandler;
import com.example.microservicio_informacion_centro_medico.security.jwt.JwtEntryPoint;
import com.example.microservicio_informacion_centro_medico.security.jwt.JwtTokenFilter;
...
public class WebSecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
            ...
            .authorizeRequests()
                .requestMatchers("/auth/*","/manage/*","publico/**").permitAll()  // Permite todas las rutas sin autenticación
